<template>
    ...
    <div class="container mx-auto text-center px-4 py-2">
        ...
        <p class="text-md ">In the next few days:</p>

        <div class="pt-4" v-if="status === 0">
        ...
        <div class="pt-4" v-if="status === 1">

            <div v-for="event in events.data" :key="event._id" class="pt-2">
                <NuxtLink :to="'/event/' + event._id"
                    ...
                    <p class="font-normal text-gray-700 dark:text-gray-400">{{ event.societyname }}</p>
                </NuxtLink>
            </div>
        </div>
